...
public class Myau {
    ...
    public void init() {
        ...
        moduleManager.modules.put(BlockESP.class, new BlockESP());
        ...
        moduleManager.modules.put(InventoryFill.class, new InventoryFill());
        ...
        moduleManager.modules.put(MouseDelayFix.class, new MouseDelayFix());
        ...
        moduleManager.modules.put(ShowNick.class, new ShowNick());
        moduleManager.modules.put(SkinHider.class, new SkinHider());
        ...
        commandManager.commands.add(new BlockESPCommand());
        commandManager.commands.add(new ItemESPCommand());
        commandManager.commands.add(new ChestStealerCommand());
        commandManager.commands.add(new SkinHiderCommand());
